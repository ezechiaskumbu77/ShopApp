...
class _CreateShopState extends State<CreateShop> {
            ...
            Column(
              children: [
                ...
                btnEnd(
                    ...
                    descContoller.text),
                     Text("ou", style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold,color: Colors.black),)
                ,btnContinuer(
                    context,
                    nameController.text,
                    quantityContoller.text,
 ...
 Widget btnEnd(BuildContext ctx, String name, String quantite,
        ...
        onPressed: () async {
          ...
          if (latController.text.isEmpty) {
            await Fluttertoast.showToast(
                msg: 'Veuillez definir la latitude',
            ...
            await Fluttertoast.showToast(
                  msg: 'Veuillez definir la longitude',
                toastLength: Toast.LENGTH_SHORT,
                gravity: ToastGravity.BOTTOM,
                backgroundColor: Colors.red,
                textColor: Colors.white,
