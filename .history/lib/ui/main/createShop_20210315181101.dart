                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      Container(
                          ...
                          child: Text('Province  :    ' ,style: TextStyle(color :Colors.black45,fontSize: 15,fontWeight: FontWeight.bold),)),

                      DropdownButton(
                          hint: Text('Selectionner une province',style: TextStyle(color :Colors.black45,fontSize: 15,fontWeight: FontWeight.bold,)),
                              ...
                              if(value=='1009'){
                                ...
                                if(_villeList.length>1)  {
                                  _villeList = [DropdownMenuItem(
                                    child: Text('',style: TextStyle(color :Colors.black45,fontSize: 15,fontWeight: FontWeight.bold,) ),
                                    value: '0',
                                ...
                                _villeList.add(DropdownMenuItem(
                                  child: Text('Kinshasa',style: TextStyle(color :Colors.black45,fontSize: 15,fontWeight: FontWeight.bold,) ),
                                  value: 'Kinshasa',
                  ...
                  Row(
                    ...
                    children: [
                      Container(
                          padding: EdgeInsets.only(left: 20),
                          child: Text('Ville  :    ' ,style: TextStyle(color :Colors.black45,fontSize: 15,fontWeight: FontWeight.bold),)),
                          ...
                          onChanged: (value) {
                            setState(() {
                              ...
                              if(value=='Kinshasa'){
                                ...
                                communeMap.forEach((elm) {
                                  _communeList.add(DropdownMenuItem(
                                    child: Text(elm['commune'],style: TextStyle(color :Colors.black45,fontSize: 15,fontWeight: FontWeight.bold) ),
                                    value: elm['value'],
                  ...
                  Row(
                    ...
                    children: [
                      Container(
                          padding: EdgeInsets.only(left: 20),
                          child: Text('Commune :    ' ,style: TextStyle(color: Colors.black45,fontSize: 15,fontWeight: FontWeight.bold),)),
